...
# SQL TEMPLATES
MS_SQL_TEMPLATE = "INSERT INTO MEMBER (MEM_id, MEM_version,DOC_id) VALUES (%s,%s,%s);"
...
OP_SQL_TEMPLATE = "INSERT INTO OPERATIONAL_POINT (OPP_id, OPP_name, OPP_uniqueid, OPP_lon, OPP_lat, OPP_taftapcode, OPP_date_start, OPP_date_end, OPP_track_nb,OPP_tunnel_nb,OPP_platform_nb, OTY_id, MEM_id) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);"
SOL_SQL_TEMPLATE = "INSERT INTO SECTION_OF_LINE (SOL_id, SOL_length, SOL_nature, SOL_imcode, SOL_date_start, SOL_date_end, SOL_track_nb, SOL_tunnel_nb, OPP_start, OPP_end, MEM_id, LIN_id ) VALUES (%s,%s,%s,%s,%s,%s,%s,%s, %s, %s, %s, %s);"
...
SOL_PARAMETER_VALUE_SQL_TEMPLATE = "INSERT INTO SOL_PARAMETER_VALUE (SOL_id, PAR_name, SPV_value) VALUES (%s,%s,%s);"
OPP_PARAMETER_VALUE_SQL_TEMPLATE = "INSERT INTO OPP_PARAMETER_VALUE (OPV_value, OPP_id, PAR_name) VALUES (%s,%s,%s);"
...
class RINFExtractor:
    ...
    def __extract_ms(self, ms):
        ...
        self.MEM_id = MEM_id
        return (MEM_id, MEM_version, DOC_id)
